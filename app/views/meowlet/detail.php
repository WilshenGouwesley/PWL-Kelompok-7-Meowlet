...
<div class="flex-1">
  ...
  <div class="flex items-center gap-3">
    <!-- FIX: tambah id dan onclick="addToCart()" -->
    <button id="btn-add-cart" onclick="addToCart()" class="flex items-center gap-2 bg-white hover:opacity-90 text-black font-bold text-[.88rem] px-6 py-2.5 rounded-xl">
...
<div>
  ...
  <p class="text-[#b0aec8] text-[.83rem] leading-relaxed mb-1">Pulpen SmoothWrite 0.5 mm enak banget dipakai nulis karena tintanya ngalir halus dan nggak seret.</p>
...
<div>
  ...
  <p class="text-[#b0aec8] text-[.83rem] leading-relaxed mb-1">Tulisan jadi kelihatan rapi, apalagi buat catatan di buku. Dipakai lama juga masih nyaman di tangan.</p>
  <div class="flex items-center gap-1.5">
    <span class="text-yellow-400 text-sm">★★★★★</span>
    <span class="text-[#7a78a0] text-[.75rem]">5.0</span>
  </div>
...
<div>
  ...
  <p class="text-[#b0aec8] text-[.83rem] leading-relaxed mb-1">Lumayan oke tapi tintanya agak boros.</p>
  <div class="flex items-center gap-1.5">
    <span class="text-yellow-400 text-sm">★★★</span>
