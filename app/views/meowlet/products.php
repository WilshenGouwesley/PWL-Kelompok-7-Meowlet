...
<div class="flex items-center justify-center gap-8 py-8">
  ...
  <!-- Stationary -->
  <button onclick="toggleCategory(this)" class="cat-btn flex flex-col items-center gap-2 group" data-active="1"
    data-cat="stationary">
    <div class="cat-circle relative w-[62px] h-[62px] rounded-full flex items-center justify-center transition-all"
      style="background:#6b5fff;box-shadow:0 8px 20px rgba(107,95,255,.35)">
      <img src="/assets/img/stationary.png" class="w-[28px] h-[28px]" />
      <span
        class="cat-badge absolute -top-1 -right-1 w-5 h-5 bg-red-500 rounded-full items-center justify-center text-white text-[.6rem] font-extrabold"
  ...
  <!-- Handycraft -->
  <button onclick="toggleCategory(this)" class="cat-btn flex flex-col items-center gap-2 group" data-active="0"
    data-cat="handycraft">
    <div class="cat-circle relative w-[62px] h-[62px] rounded-full flex items-center justify-center transition-all"
      style="background:#4a4870">
...
<div class="flex justify-end mb-6">
  <div class="relative w-[320px]">
    ...
    <button
      class="absolute right-1 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-[#fff] flex items-center justify-center hover:bg-[#7b6fff] transition-colors">
...
<div id="product-grid" class="grid grid-cols-3 gap-4">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="cat paw sharpener"
    data-tags="stationary,sharpener">
    ...
    <div class="px-3.5 pb-3.5 pt-2.5">
      ...
      <div class="flex gap-2">
        <button onclick="toggleAdded(this)"
          class="flex-1 bg-[#4a4870] text-white font-bold text-[.78rem] rounded-xl py-2 hover:bg-[#5a5890] transition-colors">Add
          to Cart</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="pen smoothwrite 0.5mm"
    data-tags="stationary,pen">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="premium cat stapler"
    data-tags="stationary,stapler">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="cool matte stapler"
    data-tags="stationary,stapler">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="detail cutting tool"
    data-tags="stationary,tools">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="joyko scissors stainless steel"
    data-tags="stationary,scissors">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
      <img src="/assets/img/joyko-scissors-stainless-steel.png" alt="joyko scissors"
        class="w-[150px] h-[150px] anim-float" />
      <button onclick="toggleHeart(this)"
        class="absolute top-2 right-2 w-9 h-9 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition-transform z-10">
        <img src="/assets/img/unfilled-heart.png" data-state="empty">
      </button>
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="sun-star cat eraser"
    data-tags="stationary,eraser">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="funny cat pens black ink"
    data-tags="stationary,pen">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="kitty cat sticky notes"
    data-tags="stationary,sticky note">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
      <img src="/assets/img/kitty-cat-sticky-note.png" alt="Kitty Cat Sticky Notes"
        class="w-[150px] h-[150px] anim-float" />
      <button onclick="toggleHeart(this)"
        class="absolute top-2 right-2 w-9 h-9 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition-transform z-10">
        <img src="/assets/img/unfilled-heart.png" data-state="empty">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="cat paw pastel highlighters"
    data-tags="stationary,highlighters">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
      <img src="/assets/img/cat-paw-pastel-highlighter.png" alt="Cat Paw Pastel Highlighters"
        class="w-[100px] h-[100px] anim-float" />
      <button onclick="toggleHeart(this)"
        class="absolute top-2 right-2 w-9 h-9 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition-transform z-10">
        <img src="/assets/img/unfilled-heart.png" data-state="empty">
      </button>
    ...
    <div class="px-3.5 pb-3.5 pt-2.5">
      ...
      <div class="flex flex-wrap gap-1.5 mb-2.5">
        <span class="bg-[#4a4870] text-[#ccc] text-[.67rem] font-semibold rounded-full px-2.5 py-0.5">Stationary</span>
        <span
          class="bg-[#4a4870] text-[#ccc] text-[.67rem] font-semibold rounded-full px-2.5 py-0.5">Highlighters</span>
      </div>
      <div class="flex items-center gap-1.5 mb-3">
        <img src="/assets/img/point.png" class="w-[22px] h-[22px]" />
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="cat silhouette paperclip"
    data-tags="stationary,paperclip">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
      <img src="/assets/img/cat-silhouette-paperclip.png" alt="Cat Silhouette PaperClip"
        class="w-[150px] h-[150px] anim-float" />
      <button onclick="toggleHeart(this)"
        class="absolute top-2 right-2 w-9 h-9 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition-transform z-10">
        <img src="/assets/img/unfilled-heart.png" data-state="empty">
  ...
  <div class="product-card bg-[#3a3852] rounded-2xl overflow-hidden" data-name="paws correction tape"
    data-tags="stationary,correction tape">
    <div class="relative bg-white rounded-xl m-2.5 mb-0 h-[170px] flex items-center justify-center overflow-hidden">
      <img src="/assets/img/paw-correction-tape.png" alt="Paws Correction Tape"
        class="w-[150px] h-[150px] anim-float" />
      <button onclick="toggleHeart(this)"
        class="absolute top-2 right-2 w-9 h-9 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition-transform z-10">
        <img src="/assets/img/unfilled-heart.png" data-state="empty">
    ...
    <div class="px-3.5 pb-3.5 pt-2.5">
      ...
      <div class="flex flex-wrap gap-1.5 mb-2.5">
        <span class="bg-[#4a4870] text-[#ccc] text-[.67rem] font-semibold rounded-full px-2.5 py-0.5">Stationary</span>
        <span class="bg-[#4a4870] text-[#ccc] text-[.67rem] font-semibold rounded-full px-2.5 py-0.5">Correction
          Tape</span>
      </div>
      <div class="flex items-center gap-1.5 mb-3">
        <img src="/assets/img/point.png" class="w-[22px] h-[22px]" />
