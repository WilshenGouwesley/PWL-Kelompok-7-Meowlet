...
<body style="font-family:'Nunito',sans-serif" class="bg-[#2d2b3d] text-[#b0aec8] min-h-screen">
  ...
  <nav class="bg-[#1e1c2e] sticky top-0 z-50 w-full flex items-center justify-between px-8 h-[54px] border-b border-white/5">
    ...
    <ul class="flex gap-8 list-none m-0 p-0 text-[.88rem]">
      ...
      <li><a href="#" class="text-[#7a78a0] font-semibold no-underline hover:text-white transition-colors">Products</a></li>
      <li><a href="#" class="text-[#7a78a0] font-semibold no-underline hover:text-white transition-colors">Cart</a></li>
  ...
  <div class="relative w-full h-[460px]">
    <img src="/assets/img/banner.png" alt="banner" id="banner-img" class="absolute inset-0 w-full h-full object-cover"/>
  </div>
  ...
  <div class="w-full px-8 pb-8">
    ...
    <div class="flex items-center gap-4 pt-4 pb-4 mt-8">
      <div class="w-[80px] h-[80px] rounded-full flex-shrink-0 -mt-8 shadow-xl">
        <img src="/assets/img/profile.png" alt="Profile" id="profile-img" class="w-full h-full object-cover"/>
      </div>
      <p class="text-white font-extrabold text-[1.2rem] -mt-4">Saquwile</p>
    </div>

    <!-- ACCORDIONS: single full-width column -->
        ...
        <div class="bg-[#3a3852] rounded-xl overflow-hidden">
          <button onclick="toggle('perks')" class="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            <span class="flex items-center gap-2 font-bold text-[.93rem] text-[#ddd]">
              Your perks
              <img src="/assets/img/about.png" alt="about" class="w-4 h-4 text-[#7a78a0]" id="c-perks"/>
            </span>
            ...
            <span class="bg-[#4a4870] text-[#ccc] text-[.72rem] font-bold rounded-full px-3 py-1 inline-flex items-center gap-2">
              ...
              <img src="/assets/img/up.png" class="w-5 h-5 text-[#7a78a0]" id="c-perks"/>
            </span>
          </button>
        </div>
        ...
        <div class="bg-[#3a3852] rounded-xl overflow-hidden">
          ...
          <div id="b-rec" data-open="1" style="overflow:hidden;transition:max-height .5s ease;max-height:2000px">
            ...
            <div class="flex justify-end p-6">
              <button class="flex items-center gap-1 text-16 text-[#aaa] hover:text-white transition-colors">
                See more
